  ...
  Setting.fromJSON(Map<String, dynamic> jsonMap) {
    try {
      ...
      for (int _i = 1; _i <= 12; _i++) {
        switch (jsonMap['home_section_' + _i.toString()]) {
          case 'search':
            homeSections.add('search');
            break;
          case 'slider':
            homeSections.add('slider');
            break;
          case 'categories_heading':
            homeSections.insert(2, 'categories_heading');
            break;
          case 'categories':
            homeSections.insert(3, 'categories');
            break;
          /*  case 'trending_week_heading':
            homeSections.add('trending_week_heading');
            break;
          case 'trending_week':
            homeSections.add('trending_week');
            break; */
          case 'top_restaurants_heading':
            homeSections.add('top_restaurants_heading');
            break;
          case 'top_restaurants':
            homeSections.add('top_restaurants');
            break;

          default:
            homeSections.add('empty');
            break;
        }
      }
    } catch (e) {
